...
public class Application {
    ...
    private final static String FITXER_XML = "universitats.xml";
    ...
    public static void menuUniversitats()
            throws GestorUniversitatsException, InputMismatchException, ArrayIndexOutOfBoundsException {
        int opcio;
        ...
        do {
            ...
            switch (opcio) {
                ...
                case 5:
                    ...
                    String nomFitxer = DADES.nextLine();
