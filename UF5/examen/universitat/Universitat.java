...
public class Universitat implements UnitatUniversitat {
    ...
    public void addCampus(Campus nouCampus) {
        if (nouCampus == null) {
            nouCampus = Campus.addCampus();
        }

        if (selectCampus(nouCampus.getNomCampus()) == -1) {
            campusList.add(nouCampus);
        } else {
    ...
    public void updateAulaEstandardCampus() {
        ...
        if (indexCampus != -1) {
            ...
            if (indexAulaEstandard != -1) {
                campusList.get(indexCampus).getAules().get(indexAulaEstandard).updateUnitatUniversitat();
            } else {
    ...
    public void updateAulaInformaticaCampus() {
        ...
        if (indexCampus != -1) {
            ...
            if (indexAulaInformatica != -1) {
                campusList.get(indexCampus).getAules().get(indexAulaInformatica).updateUnitatUniversitat();
            } else {
    ...
    public void updateLaboratoriCampus() {
        ...
        if (indexCampus != -1) {
            ...
            if (indexLaboratori != -1) {
                campusList.get(indexCampus).getAules().get(indexLaboratori).updateUnitatUniversitat();
            } else {
