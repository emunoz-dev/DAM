...
public class Campus implements UnitatUniversitat {
    ...
    public void addAulaEstandard(AulaEstandard aulaStd) {
        if (aulaStd == null) {
            aulaStd = AulaEstandard.addAulaEstandard();
        }

        if (selectAula(1, aulaStd.getCodi()) == -1) {
            aules.add(aulaStd);
        } else {
    ...
    public void addLaboratori(Laboratori novaLaboratori) {
        if (novaLaboratori == null) {
            novaLaboratori = Laboratori.addLaboratori();
        }
